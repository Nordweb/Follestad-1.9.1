 ...
 * GravDept changes:
 * ---------------------------
 * function getAttributeUsedForSortByArray() --- changed value in key:value from 'Position' to 'Best Value'
 */
...
class Mage_Catalog_Model_Config extends Mage_Eav_Model_Config
{
    ...
    {
        $options = array(
            //'position'  => Mage::helper('catalog')->__('Position')  // original
            'position'  => Mage::helper('catalog')->__('Best Value')  // custom
        );
