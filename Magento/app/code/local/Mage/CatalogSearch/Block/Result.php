 ...
 * GravDept changes:
 * ---------------------------
 * function _prepareLayout() --- modified output for $title, affects <title> and breadcrumb
 */
...
class Mage_CatalogSearch_Block_Result extends Mage_Core_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($breadcrumbs) {
            ...
            /* GravDept custom */
            //$title = $this->__("Search results for: '%s'", $this->helper('catalogsearch')->getQueryText());  /* original */
            $title = $this->__("Searched: %s", $this->helper('catalogsearch')->getQueryText());  /* custom */
