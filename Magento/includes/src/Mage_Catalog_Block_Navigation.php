 ...
 * GravDept changes:
 * ---------------------------
 * function _renderCategoryMenuItemHtml() --- modified output for CSS-driven menus
 */
...
class Mage_Catalog_Block_Navigation extends Mage_Core_Block_Template
{
        ...
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        if ($hasActiveChildren) {
            ...
            // GravDept, add children count class
            $classes[] = 'children-' . $activeChildrenCount;
            
            // GravDept, if over 8 children hide sub-sub-categories
            if ($activeChildrenCount >= 8) {
        ...
        // GravDept, hide unused JS events
        ...
        if (!empty($htmlChildren)) {
            ...
            if ($level == 1) {
            	$html[] = '<a class="view-all" tag="example" href="'.$this->getCategoryUrl($category).'">'.$this->__('View All').'</a>';
            }
