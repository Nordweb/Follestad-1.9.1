...
Original Class: Mage_Core_Model_Layout_Update
Original File: /home/follexln/public_html/dev/app/code/core/Mage/Core/Model/Layout/Update.php
...
class  Mage_Core_Model_Layout_UpdateOverriddenClass 
{
    /**
...
?><?php
if (class_exists('Extendware_EWCore_Model_Override_Mage_Core_Layout_Update_Bridge', false) === false) {
	abstract class Extendware_EWCore_Model_Override_Mage_Core_Layout_Update_Bridge extends Mage_Core_Model_Layout_UpdateOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWCore_Model_Override_Mage_Core_Layout_Update_Bridge) encountered twice');
	}
}
?><?php
class Mage_Core_Model_Layout_Update extends Extendware_EWCore_Model_Override_Mage_Core_Layout_Update {
