...
Original Class: Mage_Core_Controller_Varien_Router_Standard
Original File: /home/follexln/public_html/dev/app/code/core/Mage/Core/Controller/Varien/Router/Standard.php
...
class  Mage_Core_Controller_Varien_Router_StandardOverriddenClass  extends Mage_Core_Controller_Varien_Router_Abstract
{
...
?><?php
if (class_exists('Extendware_EWCore_Controller_Override_Mage_Core_Varien_Router_Standard_Bridge', false) === false) {
	abstract class Extendware_EWCore_Controller_Override_Mage_Core_Varien_Router_Standard_Bridge extends Mage_Core_Controller_Varien_Router_StandardOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWCore_Controller_Override_Mage_Core_Varien_Router_Standard_Bridge) encountered twice');
	}
}
?><?php
class Mage_Core_Controller_Varien_Router_Standard extends Extendware_EWCore_Controller_Override_Mage_Core_Varien_Router_Standard {
