...
Original Class: Mage_Customer_AccountController
Original File: /home/follexln/public_html/dev/app/code/core/Mage/Customer/controllers/AccountController.php
 ...
 */
class  Mage_Customer_AccountControllerOverriddenClass  extends Mage_Core_Controller_Front_Action
{
    /**
...
?><?php
if (class_exists('Extendware_EWSpamProtection_Override_Mage_Customer_AccountController_Bridge', false) === false) {
	abstract class Extendware_EWSpamProtection_Override_Mage_Customer_AccountController_Bridge extends Mage_Customer_AccountControllerOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWSpamProtection_Override_Mage_Customer_AccountController_Bridge) encountered twice');
	}
}
?><?php
class Mage_Customer_AccountController extends Extendware_EWSpamProtection_Override_Mage_Customer_AccountController {
