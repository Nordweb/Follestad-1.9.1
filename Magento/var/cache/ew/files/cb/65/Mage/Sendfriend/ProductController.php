...
Original Class: Mage_Sendfriend_ProductController
Original File: /home/follexln/public_html/dev/app/code/core/Mage/Sendfriend/controllers/ProductController.php
 ...
 */
class  Mage_Sendfriend_ProductControllerOverriddenClass  extends Mage_Core_Controller_Front_Action
{
    /**
...
?><?php
if (class_exists('Extendware_EWSpamProtection_Override_Mage_Sendfriend_ProductController_Bridge', false) === false) {
	abstract class Extendware_EWSpamProtection_Override_Mage_Sendfriend_ProductController_Bridge extends Mage_Sendfriend_ProductControllerOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWSpamProtection_Override_Mage_Sendfriend_ProductController_Bridge) encountered twice');
	}
}
?><?php
class Mage_Sendfriend_ProductController extends Extendware_EWSpamProtection_Override_Mage_Sendfriend_ProductController {
